...
{               ?>
                            <table border="1" class="table table-bordered table-striped table-vcenter js-dataTable-full-pagination">
                                            <tr>
    <th colspan="5" style="text-align: center;color: #F7CA81;font-size: 20px" class="warning">Booking Number: <?php  echo $row->BookingNumber;?></th>
  </tr>
  ...
  <tr>
   ...
   <tr>
    ...
    <th>Room Image</th>
    <td><img src="admin/images/<?php echo $row->Image;?>" width="100%" value="<?php  echo $row->Image;?>"></td>
  </tr>
 <tr>
...
<table border="1" class="table table-bordered table-striped table-vcenter js-dataTable-full-pagination">
  <tr>
    <th colspan="5" style="text-align: center;color:#F7CA81;font-size: 20px">Invoice Detail</th>
  </tr>
  <tr>
...
$cnt=$cnt+1;} ?>
<tr>
  <th colspan="2" style="text-align:center;color:#F7CA81">Grand Total </th>
...
<p style="text-align: center;font-size: 20px">
  <input name="Submit2" type="submit" class="button" style="padding:1rem 3.25rem; font-size: 2rem;font-weight: 300;border:white;border-radius:3rem;background-color:#F7CA81 ;color:white;" value="Print" onClick="return f3();" style="cursor: pointer;"  /></p>
				</div>

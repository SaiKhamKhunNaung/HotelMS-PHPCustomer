						...
						<div class="col-md-6 contact-right">
							<form method="post">
								...
								<br/>
								 ...
								 <button class="button" style="padding:1rem 3.25rem; font-size: 2rem;font-weight: 300;border:white;border-radius:3rem;background-color:#F7CA81 ;color:white;" type="submit" value="Sign Up" name="submit">Sign up</button>
						 	 </form>
						</div>

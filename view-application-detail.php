...
{               ?>
                            <table border="1" class="table table-bordered table-striped table-vcenter js-dataTable-full-pagination">
                            	<tr>
  <th colspan="4" style="color:#F7CA81;font-weight: bold;text-align: center;font-size: 20px" class="warning"> Booking Number: <?php echo $row->BookingNumber;?></th>
</tr>
<tr>
  <th colspan="4" style="color: #F7CA81;font-weight: bold;font-size: 15px"> Booking Detail:</th>
</tr>
<tr>
    <th>Customer Name</th>
  ...
  <tr>
   ...
   <tr>
    <tr>
  <th colspan="4" style="color:#F7CA81;font-weight: bold;font-size: 15px"> Room Detail:</th>
</tr>
    <th>Room Type</th>
...
<tr>
   ...
   <tr>
  <th colspan="4" style="color:#F7CA81;font-weight: bold;font-size: 15px"> Admin Remarks:</th>
</tr>
  <tr>
...
<a href="invoice.php?invid=<?php echo htmlentities ($row->tid);?>" class="button" style="padding:1rem 3.25rem; font-size: 2rem;font-weight: 300;border:white;border-radius:3rem;background-color:#F7CA81 ;color:white;">Invoice</a>
				</div>

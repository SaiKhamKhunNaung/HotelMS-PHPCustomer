				...
				<div class="contact-grids">
						...
						<div class="col-md-12 contact-right">
							<form method="post" onsubmit="return checkpass();" name="changepassword">
								...
								<br/>
								 <button class="button" style="padding:1rem 3.25rem; font-size: 2rem;font-weight: 300;border:white;border-radius:3rem;background-color:#F7CA81 ;color:white;" input type="submit" value="Change" name="submit">Change</button>
